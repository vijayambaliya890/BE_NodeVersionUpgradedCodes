...
const myChallenges = async (req, res) => {
  ...
  if (routeprivilege.challenges) {
    switch (req.route.path) {
      case "/appListOfChallenge": challengeController.appListOfChallenge(req, res); break;
      case "/appListOfAchievements": challengeController.appListOfAchievements(req, res); break;
      case "/appListOfRanks": challengeController.appListOfRanks(req, res); break;
      default:
        break;
    }
  } else {
...
challengeRouter.get("/appListOfChallenge", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.appListOfChallenge(req, res);
});
challengeRouter.get("/appListOfAchievements", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.appListOfAchievements(req, res);
});
challengeRouter.get("/appListOfRanks", __.checkRole('challenges').validate, (req, res)=>{
...
challengeRouter.post("/create", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.create(req, res);
});
challengeRouter.post("/update", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.update(req, res);
});
challengeRouter.get("/read", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.readChallenges(req, res);
});
challengeRouter.post("/uploadFiles", upload.single("file"), __.checkRole('challenges').validate, (req, res)=>{
  challengeController.uploadContentFiles(req, res);
});
challengeRouter.post("/saveBadge", badgeUpload.single("file"), __.checkRole('challenges').validate, (req, res)=>{
  challengeController.saveBadge(req, res);
});
challengeRouter.get("/manageChallenge", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.manageChallenge(req, res);
});
challengeRouter.get("/getCountOfChallenges", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.getCountOfChallenges(req, res);
});
challengeRouter.get("/exportManageChallenge", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.exportManageChallenge(req, res);
});
challengeRouter.get("/getChannelsAndBoards", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.getChannelsAndBoards(req, res);
});
challengeRouter.post("/getChannelOrBoardsUsers", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.getChannelOrBoardsUsers(req, res);
});
challengeRouter.get("/getChallengesLog", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.getChallengesLog(req, res);
});
challengeRouter.get("/readChallengeCriteriaLog", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.readChallengeCriteriaLog(req, res);
});
challengeRouter.get("/getChallengesAndUsers", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.getChallengesAndUsers(req, res);
});
challengeRouter.post("/getChallengeUsers", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.getChallengeUsers(req, res);
});

challengeRouter.get("/getNomineeQuestions", __.checkRole('challenges').validate, (req, res)=>{
...
challengeRouter.get("/getBadges", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.getBadges(req, res);
});
challengeRouter.post("/directRewards", __.checkRole('challenges').validate, (req, res)=>{
  challengeController.directRewards(req, res);
});
challengeRouter.post("/bulkUpdateDirectReward", __.checkRole('challenges').validate, (req, res)=>{
...
challengeRouter.get("/getRewardErrorLog/:challengeId", __.checkRole('challenges').validate, (req, res)=>{
