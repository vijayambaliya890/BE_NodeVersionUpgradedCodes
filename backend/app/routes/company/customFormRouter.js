...
customFormRouter.post('/createCustomForm', __.checkRole('setUpForm').validate, (req, res) => {
    customFormController.createForm(req, res);
});
customFormRouter.get('/getFormSettings/:customFormId', __.checkRole('setUpForm').validate, (req, res) => {
    customFormController.getFormSettings(req, res)
});
customFormRouter.post('/setFormSettings', __.checkRole('setUpForm').validate, (req, res) => {
    customFormController.setFormSettings(req, res)
});

customFormRouter.post('/updateCustomForm', __.checkRole('setUpForm').validate, (req, res) => {
    customFormController.updateManageForm(req, res);
});
customFormRouter.post("/exportFormCsv", __.checkRole('setUpForm').validate, (req, res) => {
    customFormController.exportFormCsv(req, res);
});
customFormRouter.get("/readManageFormLog", __.checkRole('setUpForm').validate, (req, res) => {
    customFormController.readManageFormLog(req, res);
});
customFormRouter.get("/readManageFormLog/:manageFormId", __.checkRole('setUpForm').validate, (req, res) => {
    customFormController.readManageFormStatusLog(req, res);
});
customFormRouter.get("/readMManageFormLog/:manageFormId", __.checkRole('setUpForm').validate, (req, res) => {
    customFormController.readMManageFormLog(req, res);
});
customFormRouter.get("/readFormsList", __.checkRole('setUpForm').validate, (req, res) => {
    customFormController.readFormsList(req, res);
});
customFormRouter.post('/updateManageForm', __.checkRole('setUpForm').validate, (req, res) => {
    customFormController.updateManageFormData(req, res);
});
customFormRouter.post('/exportCustomForm', __.checkRole('setUpForm').validate, (req, res) => {
    customFormController.exportWallPost(req, res);
});
customFormRouter.post('/exportManageforms', __.checkRole('setUpForm').validate, (req, res) => {
    customFormController.exportManageforms(req, res);
});
customFormRouter.post("/readManageforms/:customFormId", __.checkRole('setUpForm').validate, (req, res) => {
    customFormController.readManageforms(req, res);
});
customFormRouter.post("/readMManageforms", __.checkRole('setUpForm').validate, (req, res) => {
...
customFormRouter.post('/updateWorkflowStatus', __.checkRole('setUpForm').validate, (req, res) => {
